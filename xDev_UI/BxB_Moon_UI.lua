...
function Library:create(options)
	...
	creditsTab:credit{Name = "Player Name", Description = game.Players.LocalPlayer.Name.."    :    "..game.Players.LocalPlayer.DisplayName}
	creditsTab:credit{Name = "Account Info", Description = game.Players.LocalPlayer.AccountAge.."    :    "..game.Players.LocalPlayer.UserId}
